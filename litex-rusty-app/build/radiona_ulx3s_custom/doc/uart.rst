...
+------------------------------------------------------+-------------------------------------------+
| :ref:`UART_XOVER_RXTX <UART_XOVER_RXTX>`             | :ref:`0xf0003020 <UART_XOVER_RXTX>`       |
+------------------------------------------------------+-------------------------------------------+
| :ref:`UART_XOVER_TXFULL <UART_XOVER_TXFULL>`         | :ref:`0xf0003024 <UART_XOVER_TXFULL>`     |
+------------------------------------------------------+-------------------------------------------+
| :ref:`UART_XOVER_RXEMPTY <UART_XOVER_RXEMPTY>`       | :ref:`0xf0003028 <UART_XOVER_RXEMPTY>`    |
+------------------------------------------------------+-------------------------------------------+
| :ref:`UART_XOVER_EV_STATUS <UART_XOVER_EV_STATUS>`   | :ref:`0xf000302c <UART_XOVER_EV_STATUS>`  |
+------------------------------------------------------+-------------------------------------------+
| :ref:`UART_XOVER_EV_PENDING <UART_XOVER_EV_PENDING>` | :ref:`0xf0003030 <UART_XOVER_EV_PENDING>` |
+------------------------------------------------------+-------------------------------------------+
| :ref:`UART_XOVER_EV_ENABLE <UART_XOVER_EV_ENABLE>`   | :ref:`0xf0003034 <UART_XOVER_EV_ENABLE>`  |
+------------------------------------------------------+-------------------------------------------+
| :ref:`UART_XOVER_TXEMPTY <UART_XOVER_TXEMPTY>`       | :ref:`0xf0003038 <UART_XOVER_TXEMPTY>`    |
+------------------------------------------------------+-------------------------------------------+
| :ref:`UART_XOVER_RXFULL <UART_XOVER_RXFULL>`         | :ref:`0xf000303c <UART_XOVER_RXFULL>`     |
+------------------------------------------------------+-------------------------------------------+
