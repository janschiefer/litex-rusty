...
impl SDRAM {
    #[doc = r"Pointer to the register block"]
    pub const PTR: *const sdram::RegisterBlock = 0xf000_1000 as *const _;
    #[doc = r"Return the pointer to the register block"]
    #[inline(always)]
...
impl SPISDCARD {
    #[doc = r"Pointer to the register block"]
    pub const PTR: *const spisdcard::RegisterBlock = 0xf000_1800 as *const _;
    #[doc = r"Return the pointer to the register block"]
    #[inline(always)]
...
module"]
    ...
    pub mod clk_divider {
        ...
        #[doc = "`reset()` method sets CLK_DIVIDER to value 0x7d"]
