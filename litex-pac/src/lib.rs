...
module"]
    ...
    pub mod reset {
        ...
        pub type SOC_RST_W<'a, REG, const O: u8> = crate::BitWriter<'a, REG, O>;
        ...
        pub type CPU_RST_W<'a, REG, const O: u8> = crate::BitWriter<'a, REG, O>;
        impl R {
        ...
        impl W {
            ...
            #[inline(always)]
            #[must_use]
            pub fn soc_rst(&mut self) -> SOC_RST_W<RESET_SPEC, 0> {
                SOC_RST_W::new(self)
            }
            #[doc = "Bit 1 - Write `1` to this register to reset the CPU(s) of the SoC (Hold Reset)"]
            #[inline(always)]
            #[must_use]
            pub fn cpu_rst(&mut self) -> CPU_RST_W<RESET_SPEC, 1> {
                CPU_RST_W::new(self)
            }
...
module"]
    ...
    pub mod scratch {
        ...
        pub type SCRATCH_W<'a, REG, const O: u8> = crate::FieldWriter<'a, REG, 32, O, u32>;
        impl R {
            #[doc = "Bits 0:31"]
            #[inline(always)]
        ...
        impl W {
            ...
            #[inline(always)]
            #[must_use]
            pub fn scratch(&mut self) -> SCRATCH_W<SCRATCH_SPEC, 0> {
                SCRATCH_W::new(self)
            }
            #[doc = "Writes raw bits to the register."]
            #[inline(always)]
...
module"]
    ...
    pub mod bus_errors {
        ...
        pub type BUS_ERRORS_W<'a, REG, const O: u8> = crate::FieldWriter<'a, REG, 32, O, u32>;
        impl R {
            #[doc = "Bits 0:31"]
            #[inline(always)]
        ...
        impl W {
            ...
            #[inline(always)]
            #[must_use]
            pub fn bus_errors(&mut self) -> BUS_ERRORS_W<BUS_ERRORS_SPEC, 0> {
...
module"]
    ...
    pub mod identifier_mem {
        ...
        pub type IDENTIFIER_MEM_W<'a, REG, const O: u8> = crate::FieldWriter<'a, REG, 8, O>;
        impl R {
            #[doc = "Bits 0:7"]
            #[inline(always)]
        ...
        impl W {
            ...
            #[inline(always)]
            #[must_use]
            pub fn identifier_mem(&mut self) -> IDENTIFIER_MEM_W<IDENTIFIER_MEM_SPEC, 0> {
...
module"]
    ...
    pub mod out {
        ...
        pub type OUT_W<'a, REG, const O: u8> = crate::FieldWriter<'a, REG, 8, O>;
        impl R {
            #[doc = "Bits 0:7"]
            #[inline(always)]
...
impl SDRAM {
    #[doc = r"Pointer to the register block"]
    pub const PTR: *const sdram::RegisterBlock = 0xf000_1800 as *const _;
    #[doc = r"Return the pointer to the register block"]
    #[inline(always)]
...
module"]
    ...
    pub mod dfii_control {
        ...
        pub type ODT_R = crate::BitReader;
        #[doc = "Field `odt` writer - DFI on-die termination bus"]
        pub type ODT_W<'a, REG, const O: u8> = crate::BitWriter<'a, REG, O>;
        #[doc = "Field `reset_n` reader - DFI clock reset bus"]
        pub type RESET_N_R = crate::BitReader;
        #[doc = "Field `reset_n` writer - DFI clock reset bus"]
        pub type RESET_N_W<'a, REG, const O: u8> = crate::BitWriter<'a, REG, O>;
        impl R {
            #[doc = "Bit 0 - None"]
            #[inline(always)]
        ...
        impl W {
            ...
            #[inline(always)]
            #[must_use]
            pub fn sel(&mut self) -> SEL_W<DFII_CONTROL_SPEC, 0> {
                SEL_W::new(self)
            }
            #[doc = "Bit 1 - DFI clock enable bus"]
            #[inline(always)]
            #[must_use]
            pub fn cke(&mut self) -> CKE_W<DFII_CONTROL_SPEC, 1> {
                CKE_W::new(self)
            }
            #[doc = "Bit 2 - DFI on-die termination bus"]
            #[inline(always)]
            #[must_use]
            pub fn odt(&mut self) -> ODT_W<DFII_CONTROL_SPEC, 2> {
                ODT_W::new(self)
            }
            #[doc = "Bit 3 - DFI clock reset bus"]
            #[inline(always)]
            #[must_use]
            pub fn reset_n(&mut self) -> RESET_N_W<DFII_CONTROL_SPEC, 3> {
                RESET_N_W::new(self)
            }
            #[doc = "Writes raw bits to the register."]
            #[inline(always)]
...
module"]
    ...
    pub mod dfii_pi0_command {
        ...
        pub type R = crate::R<DFII_PI0_COMMAND_SPEC>;
        #[doc = "Register `DFII_PI0_COMMAND` writer"]
        pub type W = crate::W<DFII_PI0_COMMAND_SPEC>;
        ...
        pub type WE_R = crate::BitReader;
        #[doc = "Field `we` writer - DFI write enable bus"]
        pub type WE_W<'a, REG, const O: u8> = crate::BitWriter<'a, REG, O>;
        #[doc = "Field `cas` reader - DFI column address strobe bus"]
        pub type CAS_R = crate::BitReader;
        #[doc = "Field `cas` writer - DFI column address strobe bus"]
        pub type CAS_W<'a, REG, const O: u8> = crate::BitWriter<'a, REG, O>;
        #[doc = "Field `ras` reader - DFI row address strobe bus"]
        pub type RAS_R = crate::BitReader;
        #[doc = "Field `ras` writer - DFI row address strobe bus"]
        pub type RAS_W<'a, REG, const O: u8> = crate::BitWriter<'a, REG, O>;
        ...
        pub type RDEN_W<'a, REG, const O: u8> = crate::BitWriter<'a, REG, O>;
        #[doc = "Field `cs_top` reader - DFI chip select bus for top half only"]
        pub type CS_TOP_R = crate::BitReader;
        #[doc = "Field `cs_top` writer - DFI chip select bus for top half only"]
        pub type CS_TOP_W<'a, REG, const O: u8> = crate::BitWriter<'a, REG, O>;
        #[doc = "Field `cs_bottom` reader - DFI chip select bus for bottom half only"]
        pub type CS_BOTTOM_R = crate::BitReader;
        #[doc = "Field `cs_bottom` writer - DFI chip select bus for bottom half only"]
        pub type CS_BOTTOM_W<'a, REG, const O: u8> = crate::BitWriter<'a, REG, O>;
        impl R {
            ...
            #[doc = "Bit 6 - DFI chip select bus for top half only"]
            #[inline(always)]
            pub fn cs_top(&self) -> CS_TOP_R {
                CS_TOP_R::new(((self.bits >> 6) & 1) != 0)
            }
            #[doc = "Bit 7 - DFI chip select bus for bottom half only"]
            #[inline(always)]
            pub fn cs_bottom(&self) -> CS_BOTTOM_R {
                CS_BOTTOM_R::new(((self.bits >> 7) & 1) != 0)
            }
        }
        impl W {
            #[doc = "Bit 0 - DFI chip select bus"]
            #[inline(always)]
            #[must_use]
            pub fn cs(&mut self) -> CS_W<DFII_PI0_COMMAND_SPEC, 0> {
                CS_W::new(self)
            }
            #[doc = "Bit 1 - DFI write enable bus"]
            #[inline(always)]
            #[must_use]
            pub fn we(&mut self) -> WE_W<DFII_PI0_COMMAND_SPEC, 1> {
                WE_W::new(self)
            }
            #[doc = "Bit 2 - DFI column address strobe bus"]
            #[inline(always)]
            #[must_use]
            pub fn cas(&mut self) -> CAS_W<DFII_PI0_COMMAND_SPEC, 2> {
                CAS_W::new(self)
            }
            #[doc = "Bit 3 - DFI row address strobe bus"]
            #[inline(always)]
            #[must_use]
            pub fn ras(&mut self) -> RAS_W<DFII_PI0_COMMAND_SPEC, 3> {
                RAS_W::new(self)
            }
            #[doc = "Bit 4 - DFI write data enable bus"]
            #[inline(always)]
            #[must_use]
            pub fn wren(&mut self) -> WREN_W<DFII_PI0_COMMAND_SPEC, 4> {
                WREN_W::new(self)
            }
            #[doc = "Bit 5 - DFI read data enable bus"]
            #[inline(always)]
            #[must_use]
            pub fn rden(&mut self) -> RDEN_W<DFII_PI0_COMMAND_SPEC, 5> {
                RDEN_W::new(self)
            }
            #[doc = "Bit 6 - DFI chip select bus for top half only"]
            #[inline(always)]
            #[must_use]
            pub fn cs_top(&mut self) -> CS_TOP_W<DFII_PI0_COMMAND_SPEC, 6> {
                CS_TOP_W::new(self)
            }
            #[doc = "Bit 7 - DFI chip select bus for bottom half only"]
            #[inline(always)]
            #[must_use]
            pub fn cs_bottom(&mut self) -> CS_BOTTOM_W<DFII_PI0_COMMAND_SPEC, 7> {
                CS_BOTTOM_W::new(self)
            }
            #[doc = "Writes raw bits to the register."]
            #[inline(always)]
            pub unsafe fn bits(&mut self, bits: u32) -> &mut Self {
...
module"]
    ...
    pub mod dfii_pi0_command_issue {
        ...
        impl W {
            ...
            #[inline(always)]
            #[must_use]
            pub fn dfii_pi0_command_issue(
                &mut self,
            ) -> DFII_PI0_COMMAND_ISSUE_W<DFII_PI0_COMMAND_ISSUE_SPEC, 0> {
...
module"]
    ...
    pub mod dfii_pi0_address {
        ...
        pub type R = crate::R<DFII_PI0_ADDRESS_SPEC>;
        #[doc = "Register `DFII_PI0_ADDRESS` writer"]
        pub type W = crate::W<DFII_PI0_ADDRESS_SPEC>;
        #[doc = "Field `dfii_pi0_address` reader - "]
        pub type DFII_PI0_ADDRESS_R = crate::FieldReader<u16>;
        #[doc = "Field `dfii_pi0_address` writer - "]
        pub type DFII_PI0_ADDRESS_W<'a, REG, const O: u8> = crate::FieldWriter<'a, REG, 13, O, u16>;
        impl R {
            #[doc = "Bits 0:12"]
            #[inline(always)]
        ...
        impl W {
            ...
            #[inline(always)]
            #[must_use]
            pub fn dfii_pi0_address(&mut self) -> DFII_PI0_ADDRESS_W<DFII_PI0_ADDRESS_SPEC, 0> {
...
module"]
    ...
    pub mod dfii_pi0_baddress {
        ...
        pub type R = crate::R<DFII_PI0_BADDRESS_SPEC>;
        #[doc = "Register `DFII_PI0_BADDRESS` writer"]
        pub type W = crate::W<DFII_PI0_BADDRESS_SPEC>;
        #[doc = "Field `dfii_pi0_baddress` reader - "]
        pub type DFII_PI0_BADDRESS_R = crate::FieldReader;
        #[doc = "Field `dfii_pi0_baddress` writer - "]
        pub type DFII_PI0_BADDRESS_W<'a, REG, const O: u8> = crate::FieldWriter<'a, REG, 2, O>;
        impl R {
            #[doc = "Bits 0:1"]
            #[inline(always)]
        ...
        impl W {
            ...
            #[inline(always)]
            #[must_use]
            pub fn dfii_pi0_baddress(&mut self) -> DFII_PI0_BADDRESS_W<DFII_PI0_BADDRESS_SPEC, 0> {
...
module"]
    ...
    pub mod dfii_pi0_wrdata {
        ...
        pub type R = crate::R<DFII_PI0_WRDATA_SPEC>;
        #[doc = "Register `DFII_PI0_WRDATA` writer"]
        pub type W = crate::W<DFII_PI0_WRDATA_SPEC>;
        #[doc = "Field `dfii_pi0_wrdata` reader - "]
        pub type DFII_PI0_WRDATA_R = crate::FieldReader<u16>;
        #[doc = "Field `dfii_pi0_wrdata` writer - "]
        pub type DFII_PI0_WRDATA_W<'a, REG, const O: u8> = crate::FieldWriter<'a, REG, 16, O, u16>;
        impl R {
            #[doc = "Bits 0:15"]
            #[inline(always)]
        ...
        impl W {
            ...
            #[inline(always)]
            #[must_use]
            pub fn dfii_pi0_wrdata(&mut self) -> DFII_PI0_WRDATA_W<DFII_PI0_WRDATA_SPEC, 0> {
...
module"]
    ...
    pub mod dfii_pi0_rddata {
        ...
        pub type R = crate::R<DFII_PI0_RDDATA_SPEC>;
        #[doc = "Register `DFII_PI0_RDDATA` writer"]
        pub type W = crate::W<DFII_PI0_RDDATA_SPEC>;
        #[doc = "Field `dfii_pi0_rddata` reader - "]
        pub type DFII_PI0_RDDATA_R = crate::FieldReader<u16>;
        #[doc = "Field `dfii_pi0_rddata` writer - "]
        pub type DFII_PI0_RDDATA_W<'a, REG, const O: u8> = crate::FieldWriter<'a, REG, 16, O, u16>;
        impl R {
            #[doc = "Bits 0:15"]
            #[inline(always)]
        ...
        impl W {
            ...
            #[inline(always)]
            #[must_use]
            pub fn dfii_pi0_rddata(&mut self) -> DFII_PI0_RDDATA_W<DFII_PI0_RDDATA_SPEC, 0> {
...
unsafe impl Send for SPISDCARD {}
impl SPISDCARD {
    #[doc = r"Pointer to the register block"]
    pub const PTR: *const spisdcard::RegisterBlock = 0xf000_2000 as *const _;
    #[doc = r"Return the pointer to the register block"]
    #[inline(always)]
    pub const fn ptr() -> *const spisdcard::RegisterBlock {
        Self::PTR
    }
    #[doc = r" Steal an instance of this peripheral"]
    #[doc = r""]
...
impl Deref for SPISDCARD {
    type Target = spisdcard::RegisterBlock;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        unsafe { &*Self::PTR }
    }
}
impl core::fmt::Debug for SPISDCARD {
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        f.debug_struct("SPISDCARD").finish()
    }
}
#[doc = "SPISDCARD"]
pub mod spisdcard {
...
module"]
    ...
    pub mod control {
        ...
        pub type LENGTH_W<'a, REG, const O: u8> = crate::FieldWriter<'a, REG, 8, O>;
        impl R {
        ...
        impl W {
            ...
            #[inline(always)]
            #[must_use]
            pub fn start(&mut self) -> START_W<CONTROL_SPEC, 0> {
                START_W::new(self)
            }
            #[doc = "Bits 8:15 - SPI Xfer Length (in bits)."]
            #[inline(always)]
            #[must_use]
            pub fn length(&mut self) -> LENGTH_W<CONTROL_SPEC, 8> {
                LENGTH_W::new(self)
            }
            #[doc = "Writes raw bits to the register."]
            #[inline(always)]
...
module"]
    ...
    pub mod status {
        ...
        impl W {
            ...
            #[inline(always)]
            #[must_use]
            pub fn done(&mut self) -> DONE_W<STATUS_SPEC, 0> {
                DONE_W::new(self)
            }
            #[doc = "Bit 1 - SPI mode"]
            #[inline(always)]
            #[must_use]
            pub fn mode(&mut self) -> MODE_W<STATUS_SPEC, 1> {
                MODE_W::new(self)
            }
            #[doc = "Writes raw bits to the register."]
            #[inline(always)]
...
module"]
    ...
    pub mod mosi {
        ...
        pub type R = crate::R<MOSI_SPEC>;
        #[doc = "Register `MOSI` writer"]
        pub type W = crate::W<MOSI_SPEC>;
        #[doc = "Field `mosi` reader - "]
        pub type MOSI_R = crate::FieldReader;
        #[doc = "Field `mosi` writer - "]
        pub type MOSI_W<'a, REG, const O: u8> = crate::FieldWriter<'a, REG, 8, O>;
        impl R {
            #[doc = "Bits 0:7"]
            #[inline(always)]
        ...
        impl W {
            ...
            #[inline(always)]
            #[must_use]
            pub fn mosi(&mut self) -> MOSI_W<MOSI_SPEC, 0> {
                MOSI_W::new(self)
            }
            #[doc = "Writes raw bits to the register."]
            #[inline(always)]
...
module"]
    ...
    pub mod miso {
        ...
        pub type R = crate::R<MISO_SPEC>;
        #[doc = "Register `MISO` writer"]
        pub type W = crate::W<MISO_SPEC>;
        #[doc = "Field `miso` reader - "]
        pub type MISO_R = crate::FieldReader;
        #[doc = "Field `miso` writer - "]
        pub type MISO_W<'a, REG, const O: u8> = crate::FieldWriter<'a, REG, 8, O>;
        impl R {
            #[doc = "Bits 0:7"]
            #[inline(always)]
        ...
        impl W {
            ...
            #[inline(always)]
            #[must_use]
            pub fn miso(&mut self) -> MISO_W<MISO_SPEC, 0> {
                MISO_W::new(self)
            }
            #[doc = "Writes raw bits to the register."]
            #[inline(always)]
...
module"]
    ...
    pub mod cs {
        ...
        impl W {
            ...
            #[inline(always)]
            #[must_use]
            pub fn sel(&mut self) -> SEL_W<CS_SPEC, 0> {
                SEL_W::new(self)
            }
            #[doc = "Bit 16 - None"]
            #[inline(always)]
            #[must_use]
            pub fn mode(&mut self) -> MODE_W<CS_SPEC, 16> {
                MODE_W::new(self)
            }
            #[doc = "Writes raw bits to the register."]
            #[inline(always)]
...
module"]
    ...
    pub mod loopback {
        ...
        pub type R = crate::R<LOOPBACK_SPEC>;
        #[doc = "Register `LOOPBACK` writer"]
        pub type W = crate::W<LOOPBACK_SPEC>;
        #[doc = "Field `mode` reader - None"]
        pub type MODE_R = crate::BitReader;
        #[doc = "Field `mode` writer - None"]
        pub type MODE_W<'a, REG, const O: u8> = crate::BitWriter<'a, REG, O>;
        ...
        impl W {
            ...
            #[inline(always)]
            #[must_use]
            pub fn mode(&mut self) -> MODE_W<LOOPBACK_SPEC, 0> {
                MODE_W::new(self)
            }
            #[doc = "Writes raw bits to the register."]
            #[inline(always)]
...
module"]
    ...
    pub mod clk_divider {
        ...
        impl W {
            ...
            #[inline(always)]
            #[must_use]
            pub fn clk_divider(&mut self) -> CLK_DIVIDER_W<CLK_DIVIDER_SPEC, 0> {
        ...
        #[doc = "`reset()` method sets CLK_DIVIDER to value 0x3f"]
...
impl TIMER0 {
    #[doc = r"Pointer to the register block"]
    pub const PTR: *const timer0::RegisterBlock = 0xf000_2800 as *const _;
    #[doc = r"Return the pointer to the register block"]
    #[inline(always)]
...
module"]
    ...
    pub mod reload {
        ...
        pub type RELOAD_W<'a, REG, const O: u8> = crate::FieldWriter<'a, REG, 32, O, u32>;
        impl R {
            #[doc = "Bits 0:31"]
            #[inline(always)]
        ...
        impl W {
            ...
            #[inline(always)]
            #[must_use]
            pub fn reload(&mut self) -> RELOAD_W<RELOAD_SPEC, 0> {
                RELOAD_W::new(self)
            }
            #[doc = "Writes raw bits to the register."]
            #[inline(always)]
...
module"]
    ...
    pub mod en {
        ...
        impl W {
            ...
            #[inline(always)]
            #[must_use]
            pub fn en(&mut self) -> EN_W<EN_SPEC, 0> {
                EN_W::new(self)
            }
            #[doc = "Writes raw bits to the register."]
            #[inline(always)]
...
module"]
    ...
    pub mod update_value {
        ...
        pub type UPDATE_VALUE_W<'a, REG, const O: u8> = crate::BitWriter<'a, REG, O>;
        impl R {
            #[doc = "Bit 0"]
            #[inline(always)]
        ...
        impl W {
            ...
            #[inline(always)]
            #[must_use]
            pub fn update_value(&mut self) -> UPDATE_VALUE_W<UPDATE_VALUE_SPEC, 0> {
...
module"]
    ...
    pub mod value {
        ...
        impl W {
            ...
            #[inline(always)]
            #[must_use]
            pub fn value(&mut self) -> VALUE_W<VALUE_SPEC, 0> {
                VALUE_W::new(self)
            }
            #[doc = "Writes raw bits to the register."]
            #[inline(always)]
...
module"]
    ...
    pub mod ev_status {
        ...
        impl W {
            ...
            #[inline(always)]
            #[must_use]
            pub fn zero(&mut self) -> ZERO_W<EV_STATUS_SPEC, 0> {
                ZERO_W::new(self)
            }
            #[doc = "Writes raw bits to the register."]
            #[inline(always)]
...
module"]
    ...
    pub mod ev_pending {
        ...
        impl W {
            ...
            #[inline(always)]
            #[must_use]
            pub fn zero(&mut self) -> ZERO_W<EV_PENDING_SPEC, 0> {
                ZERO_W::new(self)
            }
            #[doc = "Writes raw bits to the register."]
            #[inline(always)]
...
module"]
    ...
    pub mod ev_enable {
        ...
        impl W {
            ...
            #[inline(always)]
            #[must_use]
            pub fn zero(&mut self) -> ZERO_W<EV_ENABLE_SPEC, 0> {
                ZERO_W::new(self)
            }
            #[doc = "Writes raw bits to the register."]
            #[inline(always)]
...
module"]
    ...
    pub mod rxtx {
        ...
        pub type RXTX_W<'a, REG, const O: u8> = crate::FieldWriter<'a, REG, 8, O>;
        impl R {
            #[doc = "Bits 0:7"]
            #[inline(always)]
        ...
        impl W {
            ...
            #[inline(always)]
            #[must_use]
            pub fn rxtx(&mut self) -> RXTX_W<RXTX_SPEC, 0> {
                RXTX_W::new(self)
            }
            #[doc = "Writes raw bits to the register."]
            #[inline(always)]
...
module"]
    ...
    pub mod txfull {
        ...
        pub type TXFULL_W<'a, REG, const O: u8> = crate::BitWriter<'a, REG, O>;
        impl R {
            #[doc = "Bit 0"]
            #[inline(always)]
        ...
        impl W {
            ...
            #[inline(always)]
            #[must_use]
            pub fn txfull(&mut self) -> TXFULL_W<TXFULL_SPEC, 0> {
                TXFULL_W::new(self)
            }
            #[doc = "Writes raw bits to the register."]
            #[inline(always)]
...
module"]
    ...
    pub mod rxempty {
        ...
        pub type RXEMPTY_W<'a, REG, const O: u8> = crate::BitWriter<'a, REG, O>;
        impl R {
            #[doc = "Bit 0"]
            #[inline(always)]
        ...
        impl W {
            ...
            #[inline(always)]
            #[must_use]
            pub fn rxempty(&mut self) -> RXEMPTY_W<RXEMPTY_SPEC, 0> {
                RXEMPTY_W::new(self)
            }
            #[doc = "Writes raw bits to the register."]
            #[inline(always)]
...
module"]
    ...
    pub mod ev_status {
        ...
        impl W {
            ...
            #[inline(always)]
            #[must_use]
            pub fn tx(&mut self) -> TX_W<EV_STATUS_SPEC, 0> {
                TX_W::new(self)
            }
            #[doc = "Bit 1 - Level of the ``rx`` event"]
            #[inline(always)]
            #[must_use]
            pub fn rx(&mut self) -> RX_W<EV_STATUS_SPEC, 1> {
                RX_W::new(self)
            }
            #[doc = "Writes raw bits to the register."]
            #[inline(always)]
...
module"]
    ...
    pub mod ev_pending {
        ...
        impl W {
            ...
            #[inline(always)]
            #[must_use]
            pub fn tx(&mut self) -> TX_W<EV_PENDING_SPEC, 0> {
                TX_W::new(self)
            }
            #[doc = "Bit 1 - `1` if a `rx` event occurred. This Event is triggered on a **falling** edge."]
            #[inline(always)]
            #[must_use]
            pub fn rx(&mut self) -> RX_W<EV_PENDING_SPEC, 1> {
                RX_W::new(self)
            }
            #[doc = "Writes raw bits to the register."]
            #[inline(always)]
...
module"]
    ...
    pub mod ev_enable {
        ...
        impl W {
            ...
            #[inline(always)]
            #[must_use]
            pub fn tx(&mut self) -> TX_W<EV_ENABLE_SPEC, 0> {
                TX_W::new(self)
            }
            #[doc = "Bit 1 - Write a ``1`` to enable the ``rx`` Event"]
            #[inline(always)]
            #[must_use]
            pub fn rx(&mut self) -> RX_W<EV_ENABLE_SPEC, 1> {
                RX_W::new(self)
            }
            #[doc = "Writes raw bits to the register."]
            #[inline(always)]
...
module"]
    ...
    pub mod txempty {
        ...
        impl W {
            ...
            #[inline(always)]
            #[must_use]
            pub fn txempty(&mut self) -> TXEMPTY_W<TXEMPTY_SPEC, 0> {
                TXEMPTY_W::new(self)
            }
            #[doc = "Writes raw bits to the register."]
            #[inline(always)]
...
module"]
    ...
    pub mod rxfull {
        ...
        impl W {
            ...
            #[inline(always)]
            #[must_use]
            pub fn rxfull(&mut self) -> RXFULL_W<RXFULL_SPEC, 0> {
                RXFULL_W::new(self)
            }
            #[doc = "Writes raw bits to the register."]
            #[inline(always)]
